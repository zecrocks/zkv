...
pub type WalletErrorT = WalletError<
    SqliteClientError,
...
pub type SendMaxErrorT = WalletError<
    SqliteClientError,
    commitment_tree::Error,
    BalanceError,
    zip317::FeeError,
...
pub type ShieldErrorT = WalletError<
    SqliteClientError,
    commitment_tree::Error,
    GreedyInputSelectorError,
    zip317::FeeError,
...
#[derive(Debug)]
#[allow(dead_code)] // Some variants are produced by `From` impls inside zcash crates.
pub enum Error {
