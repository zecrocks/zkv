...
const KeyList = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "main" }, /* @__PURE__ */ React.createElement("div", { className: "main-toolbar" }, tab !== "roles" && /* @__PURE__ */ React.createElement("div", { className: "kv-filter", style: { position: "relative" } }, /* @__PURE__ */ React.createElement(Icon, { name: "search", size: 12, style: { position: "absolute", left: 9, top: 8, color: "var(--fg-3)" } }), /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Icon, { name: "alert-triangle", size: 14, color: "var(--amber-400)" }),
    /* @__PURE__ */ React.createElement("span", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, syncError)
...
const KeyDetail = ({ row, db, timeZone, onWriteKey, onDelete, onCopy, onViewHistory, onOpenTxid, signer, roles, onOpenRole, loading, error, onRetry }) => {
  if (!row) {
    return /* @__PURE__ */ React.createElement("aside", { className: "detail" }, /* @__PURE__ */ React.createElement("div", { className: "empty" }, /* @__PURE__ */ React.createElement("div", { className: "glyph" }, /* @__PURE__ */ React.createElement(Icon, { name: error ? "alert-triangle" : loading ? "loader" : "mouse-pointer-click", size: 28 })), error ? /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", null, "Couldn't load this database."), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 14 } }, /* @__PURE__ */ React.createElement("button", { className: "btn primary sm", onClick: () => onRetry && onRetry() }, /* @__PURE__ */ React.createElement(Icon, { name: "refresh-cw", className: "icon" }), " Retry"))) : /* @__PURE__ */ React.createElement("div", null, loading ? "Loading\u2026" : "Select a key to inspect its current value and on-chain write.")));
  }
  const isAdmin = db && db.role === "admin";
