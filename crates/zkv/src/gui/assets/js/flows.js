...
const DepositModal = ({ db, onClose, onCopy, onInited }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "modal", role: "dialog", style: { maxWidth: 420 } }, /* @__PURE__ */ React.createElement("div", { className: "modal-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "eyebrow" }, "DB: ", db.name), /* @__PURE__ */ React.createElement("h2", null, "Add ", db.network, " funds"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: "var(--fg-3)", marginTop: 4 } }, "Send ", cur, " to this database's funding address. Each write costs about ", feeAmt, ", just the network fee.")), /* @__PURE__ */ React.createElement("button", { className: "close", onClick: onClose, title: "Close" }, /* @__PURE__ */ React.createElement(Icon, { name: "x", size: 16 }))), /* @__PURE__ */ React.createElement("div", { className: "modal-body" }, addr ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "qr-card", style: { margin: "0 auto", maxWidth: 300, border: "none", background: "transparent", padding: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "qr" }, /* @__PURE__ */ React.createElement(Qr, { text: addr }))), /* @__PURE__ */ React.createElement("div", { className: "kv-row", style: { marginTop: 16 } }, /* @__PURE__ */ React.createElement("span", { className: "label", style: { minWidth: 110 } }, "Funding address"), /* @__PURE__ */ React.createElement("span", { className: "value" }, /* @__PURE__ */ React.createElement(CollapsibleString, { value: addr, onCopy }))), db.network === "mainnet" && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 4 } }, /* @__PURE__ */ React.createElement(ValidAddressInfo, null)), /* @__PURE__ */ React.createElement("div", { className: "kv-row", style: { marginTop: 10 } }, /* @__PURE__ */ React.createElement("span", { className: "label", style: { minWidth: 110 } }, "Spendable"), /* @__PURE__ */ React.createElement("span", { className: "value mono" }, db.balance != null ? window.formatZats(Math.max(0, db.balance - (db.confirming || 0)), db.network) : "\u2014", db.confirming ? /* @__PURE__ */ React.createElement("span", { style: { color: "var(--fg-3)" } }, " (+ ", window.formatZats(db.confirming, db.network), " confirming)") : null))) : /* @__PURE__ */ React.createElement("div", { className: "callout-flow warn" }, /* @__PURE__ */ React.createElement(Icon, { name: "alert-triangle", size: 16, color: "var(--amber-400)" }), /* @__PURE__ */ React.createElement("div", null, "Watch-only databases hold no spending key, so there's nothing to fund."))), /* @__PURE__ */ React.createElement("div", { className: "modal-foot" }, /* @__PURE__ */ React.createElement("div", { className: "cost" }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8 } }, showInitFaucet && /* @__PURE__ */ React.createElement(
      ...
      " ",
      initLabel
    ), addr && /* @__PURE__ */ React.createElement(
      "button",
      {
        className: "btn secondary",
...
const SendModal = ({ db, onClose, onCopy, onDeposit, onDone }) => {
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "byte-counter" }, /* @__PURE__ */ React.createElement("span", { className: amtTrim === "" ? "" : amtOk && !overBalance ? "ok" : "err" }, amtTrim === "" ? "required" : tooManyDecimals ? "at most 8 decimal places" : !amtMatch || amtZats <= 0 ? "enter an amount greater than zero" : overBalance ? "more than the available balance" : ""), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--green-500)", fontFamily: "var(--font-mono)" } }, "balance ", haveBal ? window.formatZats(db.balance, db.network) : "\u2014"))), /* @__PURE__ */ React.createElement("div", { className: "field-block" }, /* @__PURE__ */ React.createElement("label", null, "Memo ", /* @__PURE__ */ React.createElement("span", { style: { color: "var(--fg-3)", fontWeight: 400 } }, "\xB7 optional")), /* @__PURE__ */ React.createElement(
    "textarea",
    {
...
const ImportFlow = ({ onCancel, onWatch, onRestore, onComplete }) => {
  ...
  React.useEffect(() => {
    ...
    setInspecting(true);
    setAddrInfo(null);
    window.zkvApi.inspectAddress(addr.trim()).then((info) => alive && setAddrInfo(info)).catch(() => alive && setAddrInfo(null)).finally(() => alive && setInspecting(false));
    return () => {
      alive = false;
    };
  }, [method, addr, parsed]);
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "modal-overlay", onClick: dismiss }, /* @__PURE__ */ React.createElement("div", { className: "modal", role: "dialog", "aria-labelledby": "import-title" }, /* @__PURE__ */ React.createElement("div", { className: "modal-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "eyebrow" }, "IMPORT \xB7 RESTORE"), /* @__PURE__ */ React.createElement("h2", { id: "import-title" }, "Restore admin access"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: "var(--fg-3)", marginTop: 4 } }, "Paste the database's zkv address and your 24-word recovery phrase.")), !busy && /* @__PURE__ */ React.createElement("button", { className: "close", onClick: onCancel, title: "Close" }, /* @__PURE__ */ React.createElement(Icon, { name: "x", size: 16 }))), /* @__PURE__ */ React.createElement("div", { className: "modal-body" }, /* @__PURE__ */ React.createElement("div", { className: "write-fields" }, /* @__PURE__ */ React.createElement(ErrBanner, null), /* @__PURE__ */ React.createElement("div", { className: "callout-flow warn" }, /* @__PURE__ */ React.createElement(Icon, { name: "alert-triangle", size: 16, color: "var(--amber-400)" }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("strong", { style: { color: "inherit" } }, "Do not use any seed phrase you have ever used in a Zcash wallet."), " ", "z:kv databases are not private, anyone with your ", /* @__PURE__ */ React.createElement("code", null, "zkv1"), " address can view the wallet and database's entire transaction history by design.")), /* @__PURE__ */ React.createElement("div", { className: "field-block" }, /* @__PURE__ */ React.createElement("label", null, "zkv address"), /* @__PURE__ */ React.createElement(
    "textarea",
    {
      className: "input addr-input",
      style: { minHeight: 78, fontFamily: "var(--font-mono)" },
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "addr-preview", "data-state": addrInfo ? "parsed" : addrState, style: { marginTop: 8 } }, addrState === "empty" && /* @__PURE__ */ React.createElement("span", { className: "prev-empty" }, /* @__PURE__ */ React.createElement(Icon, { name: "link-2", size: 12 }), " paste the database's address, starting with ", /* @__PURE__ */ React.createElement("code", null, "zkv1\u2026")), addrState === "invalid" && /* @__PURE__ */ React.createElement("span", { className: "prev-invalid" }, /* @__PURE__ */ React.createElement(Icon, { name: "alert-circle", size: 12 }), " not a valid zkv address, expected a ", /* @__PURE__ */ React.createElement("code", null, "zkv1\u2026"), " token"), addrState === "parsed" && inspecting && /* @__PURE__ */ React.createElement("span", { className: "prev-empty" }, /* @__PURE__ */ React.createElement("div", { className: "spinner" }), " reading network and pool\u2026"), addrState === "parsed" && !inspecting && !addrInfo && /* @__PURE__ */ React.createElement("span", { className: "prev-invalid" }, /* @__PURE__ */ React.createElement(Icon, { name: "alert-circle", size: 12 }), " couldn't read this address; check it and try again"), addrState === "parsed" && !inspecting && addrInfo && /* @__PURE__ */ React.createElement("span", { className: "prev-ok", style: { display: "inline-flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement(Icon, { name: "check", size: 12 }), /* @__PURE__ */ React.createElement("span", { className: "net-badge", "data-net": addrInfo.network }, addrInfo.network), /* @__PURE__ */ React.createElement("span", { className: "db-pool" }, addrInfo.pool), /* @__PURE__ */ React.createElement("span", null, "\xB7 birthday ", addrInfo.birthday)))), /* @__PURE__ */ React.createElement("div", { className: "field-block" }, /* @__PURE__ */ React.createElement("label", null, "24-word recovery phrase"), /* @__PURE__ */ React.createElement(
    "textarea",
    {
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "hint" }, phraseWords.length > 0 && phraseWords.length < 24 && /* @__PURE__ */ React.createElement("span", { style: { color: "var(--amber-400)" } }, phraseWords.length, " / 24 words"), phraseWords.length === 24 && /* @__PURE__ */ React.createElement("span", { style: { color: "var(--green-500)" } }, /* @__PURE__ */ React.createElement(Icon, { name: "check", size: 11 }), " 24 words detected"), phraseWords.length > 24 && /* @__PURE__ */ React.createElement("span", { style: { color: "var(--red-500)" } }, /* @__PURE__ */ React.createElement(Icon, { name: "x", size: 11 }), " ", phraseWords.length, " words, phrase is too long"))), /* @__PURE__ */ React.createElement("div", { className: "field-block" }, /* @__PURE__ */ React.createElement("label", null, "Local database nickname"), /* @__PURE__ */ React.createElement("input", { className: "input lg", value: nickname, onChange: (e) => setNickname(e.target.value), maxLength: 24 })))), /* @__PURE__ */ React.createElement("div", { className: "modal-foot" }, /* @__PURE__ */ React.createElement("div", { className: "cost", style: { fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--fg-3)" } }, "equivalent to ", /* @__PURE__ */ React.createElement("code", null, "zkv restore ", nickname || "<name>")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8 } }, /* @__PURE__ */ React.createElement("button", { className: "btn secondary", onClick: () => setMethod(null), disabled: busy }, "\u2190 Back"), /* @__PURE__ */ React.createElement("button", { className: "btn primary", disabled: !phraseOk || !nickname.trim() || !addrInfo || busy, onClick: submitRestore }, busy ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "spinner" }), " Restoring\u2026") : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Icon, { name: "key-round", className: "icon" }), " Restore"))))));
};
