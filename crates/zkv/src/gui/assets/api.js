(function() {
  ...
  const ipcApi = {
    ...
    restore: (name, phrase, network, birthday) => call("restore", { name, phrase, network, birthday }),
  ...
  const httpApi = {
    ...
    restore: (name, phrase, network, birthday) => req("POST", "/api/restore", { name, phrase, network, birthday }),
